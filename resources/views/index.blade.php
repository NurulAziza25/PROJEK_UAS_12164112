    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <h1 class="text-uppercase text-white font-weight-bold">HAI TEMAN-TEMAN</h1>
          <hr class="divider my-4">
        </div>
        <div class="col-lg-8 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">"My Day"</p>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          <h2 class="mt-0">Hubungi Kontak dan Akun Sosial Media Kami</h2>
          <hr class="divider my-4">
          <p class="text-muted mb-5">Instagram : @nzaziza</p>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto text-center">
          ...
          <a class="d-block" href="zhizha250998@gmail.com">zhizha250998@gmail.com</a>
        </div>
      </div>
    </div>
  </section>
